    ...
    try {
      ...
      <body>
          <div class="container">
            ...
            <p>Your One-Time Password (OTP) for verification is: ${newOtp}</p>
  ...
  generateOtpRegister = async (req, res) => {
    try {
      ...
      <body>
          <div class="container">
            Hello,
            <p>Thank you for choosing NexUnity! To ensure the security of your account, we require you to verify your email address.</p>
